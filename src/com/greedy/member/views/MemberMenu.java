...
public class MemberMenu {
	...
	public Map<String, String> inputMember() {
		...
		System.out.println("등록할 회원의 ID를 입력해주세요");
		String memberId = sc.nextLine();
		System.out.println("등록할 회원의 password를 입력해주세요");
		String memberPwd = sc.nextLine();
		System.out.println("등록할 이름을 정해주세요");
		String memberName = sc.nextLine();
		System.out.println("등록할 성별을 정해주세요");
		String gender  = sc.nextLine();
		System.out.println("등록할 이메일을 적어주세요");
		String email  = sc.nextLine();
		System.out.println("등록할 전화번호를 입력하세요");
		String phone = sc.nextLine();
		System.out.println("주소를 등록하세요");
